import { n as _t, s as ce, T as L, o as ot, R as jo, a as C, t as W, p as K, y as gt } from "./index-CkfYfOAR.mjs";
import { h as B } from "./auth-manager-BLHwoT4w.mjs";
/**
 * @license
 ...
 */
var Ee;
const ue = window, kr = ue.trustedTypes, zo = kr ? kr.emptyScript : "", Ir = ue.reactiveElementPolyfillSupport, ar = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? zo : null;
      break;
  ...
  return r;
} }, io = (e, t) => t !== e && (t == t || e == e), Ae = { attribute: !0, type: String, converter: ar, reflect: !1, hasChanged: io }, lr = "finalized";
let $t = class extends HTMLElement {
  ...
  _$EO(t, r, n = Ae) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const s = (((o = n.converter) === null || o === void 0 ? void 0 : o.toAttribute) !== void 0 ? n.converter : ar).toAttribute(r, n.type);
  ...
  _$AK(t, r) {
    ...
    if (i !== void 0 && this._$El !== i) {
      const s = o.getPropertyOptions(i), a = typeof s.converter == "function" ? { fromAttribute: s.converter } : ((n = s.converter) === null || n === void 0 ? void 0 : n.fromAttribute) !== void 0 ? s.converter : ar;
...
$t[lr] = !0, $t.elementProperties = /* @__PURE__ */ new Map(), $t.elementStyles = [], $t.shadowRootOptions = { mode: "open" }, Ir == null || Ir({ ReactiveElement: $t }), ((Ee = ue.reactiveElementVersions) !== null && Ee !== void 0 ? Ee : ue.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var _e;
const me = window, Ot = me.trustedTypes, Tr = Ot ? Ot.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, cr = "$lit$", rt = `lit$${(Math.random() + "").slice(9)}$`, so = "?" + rt, Fo = `<${so}>`, ft = document, Zt = () => ft.createComment(""), Vt = (e) => e === null || typeof e != "object" && typeof e != "function", ao = Array.isArray, Zo = (e) => ao(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Oe = `[ 	
\f\r]`, Rt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Pr = /-->/g, Mr = />/g, lt = RegExp(`>|${Oe}(?:([^\\s"'>=/]+)(${Oe}*=${Oe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Sr = /'/g, Rr = /"/g, lo = /^(?:script|style|textarea|title)$/i, co = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), m = co(1), he = co(2), pt = Symbol.for("lit-noChange"), N = Symbol.for("lit-nothing"), Lr = /* @__PURE__ */ new WeakMap(), ut = ft.createTreeWalker(ft, 129, null, !1);
function ho(e, t) {
...
const Vo = (e, t) => {
  ...
  for (let a = 0; a < r; a++) {
    ...
    i += s === Rt ? l + Fo : b >= 0 ? (n.push(c), l.slice(0, b) + cr + l.slice(b) + rt + f) : l + rt + (b === -2 ? (n.push(void 0), a) : f);
  }
      ...
      if (o.nodeType === 1) {
        if (o.hasAttributes()) {
          ...
          for (const h of o.getAttributeNames())
            if (h.endsWith(cr) || h.startsWith(rt)) {
              const f = d[s++];
              if (b.push(h), f !== void 0) {
                const p = o.getAttribute(f.toLowerCase() + cr).split(rt), g = /([.?@])?(.*)/.exec(f);
                l.push({ type: 1, index: i, name: g[2], strings: p, ctor: g[1] === "." ? qo : g[1] === "?" ? Jo : g[1] === "@" ? Go : be });
              } else
...
class Jt {
  constructor(t, r, n, o) {
    var i;
    this.type = 2, this._$AH = N, this._$AN = void 0, this._$AA = t, this._$AB = r, this._$AM = n, this.options = o, this._$Cp = (i = o == null ? void 0 : o.isConnected) === null || i === void 0 || i;
  }
  get _$AU() {
    var t, r;
  ...
  _$AI(t, r = this) {
    t = kt(this, t, r), Vt(t) ? t === N || t == null || t === "" ? (this._$AH !== N && this._$AR(), this._$AH = N) : t !== this._$AH && t !== pt && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Zo(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== N && Vt(this._$AH) ? this._$AA.nextSibling.data = t : this.$(ft.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var r;
...
class be {
  constructor(t, r, n, o, i) {
    this.type = 1, this._$AH = N, this._$AN = void 0, this.element = t, this.name = r, this._$AM = o, this.options = i, n.length > 2 || n[0] !== "" || n[1] !== "" ? (this._$AH = Array(n.length - 1).fill(new String()), this.strings = n) : this._$AH = N;
  }
  get tagName() {
  ...
  _$AI(t, r = this, n, o) {
    ...
    if (i === void 0)
      ...
      for (t = i[0], l = 0; l < i.length - 1; l++)
        c = kt(this, a[n + l], r, l), c === pt && (c = this._$AH[l]), s || (s = !Vt(c) || c !== this._$AH[l]), c === N ? t = N : t !== N && (t += (c ?? "") + i[l + 1]), this._$AH[l] = c;
    }
    s && !o && this.j(t);
  }
  j(t) {
...
let Jo = class extends be {
  ...
  j(t) {
    t && t !== N ? this.element.setAttribute(this.name, Yo) : this.element.removeAttribute(this.name);
  }
};
class Go extends be {
  constructor(t, r, n, o, i) {
  ...
  _$AI(t, r = this) {
    var n;
    if ((t = (n = kt(this, t, r, 0)) !== null && n !== void 0 ? n : N) === pt)
      return;
    const o = this._$AH, i = t === N && o !== N || t.capture !== o.capture || t.once !== o.once || t.passive !== o.passive, s = t !== N && (o === N || i);
...
const Nr = me.litHtmlPolyfillSupport;
Nr == null || Nr(Kt, Jt), ((_e = me.litHtmlVersions) !== null && _e !== void 0 ? _e : me.litHtmlVersions = []).push("2.8.0");
const Xo = (e, t, r) => {
  var n, o;
...
const uo = (e, t, r) => Math.min(Math.max(r, e), t), Z = {
  ...
  repeat: 0,
  easing: "ease"
}, ge = (e) => typeof e == "number", Et = (e) => Array.isArray(e) && !ge(e[0]), an = (e, t, r) => {
  const n = t - e;
  return ((r - e) % n + n) % n + e;
};
function ln(e, t) {
...
const po = (e) => Array.isArray(e) && ge(e[0]), dr = (e) => typeof e == "object" && !!e.createAnimation, It = (e) => typeof e == "function", hn = (e) => typeof e == "string", zt = {
  ms: (e) => e * 1e3,
  s: (e) => e / 1e3
...
const bn = ["", "X", "Y", "Z"], yn = ["translate", "scale", "rotate", "skew"], fe = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
}, jr = {
  ...
  skew: jr
}, qt = /* @__PURE__ */ new Map(), yr = (e) => `--motion-${e}`, pe = ["x", "y", "z"];
yn.forEach((e) => {
  bn.forEach((t) => {
    pe.push(e + t), qt.set(yr(e + t), xn[e]);
  });
});
const $n = (e, t) => pe.indexOf(e) - pe.indexOf(t), Cn = new Set(pe), yo = (e) => Cn.has(e), En = (e, t) => {
  fe[t] && (t = fe[t]);
...
for (const e in Hr)
  Ct[e] = () => (Se[e] === void 0 && (Se[e] = Hr[e]()), Se[e]);
...
function ur(e) {
  return fe[e] && (e = fe[e]), yo(e) ? yr(e) : e;
}
const Xt = {
  get: (e, t) => {
    t = ur(t);
...
function Ln(e, t, r, n = {}, o) {
  ...
  return xo(M.animation, !(dr(h) && M.generator) && n.record !== !1), () => {
    const U = () => {
      var R, Y;
    ...
    if (hr(E) && (Ct.cssRegisterProperty() ? On(E) : v = !1), w && !Ct.linearEasing() && (It(h) || Et(h) && h.some(It)) && (v = !1), v) {
      S && (P = P.map((D) => ge(D) ? S.toDefaultUnit(D) : D)), P.length === 1 && (!Ct.partialKeyframes() || s) && P.unshift(U());
      const R = {
        delay: zt.ms(c),
        duration: zt.ms(l),
        endDelay: zt.ms(d),
      ...
      Xt.set(e, E, S && ge(R) ? S.toDefaultUnit(R) : R);
    }
    return s && i(e, t, P, {
      duration: l,
      delay: c,
...
xe.getBlocksCount = function(t, r) {
  switch (r) {
    case nt.L:
      return te[(t - 1) * 4 + 0];
    case nt.M:
...
xe.getTotalCodewordsCount = function(t, r) {
  switch (r) {
    case nt.L:
      return ee[(t - 1) * 4 + 0];
    case nt.M:
...
var ko = {}, $e = {};
const Ft = new Uint8Array(512), we = new Uint8Array(256);
(function() {
  let t = 1;
  for (let r = 0; r < 255; r++)
    Ft[r] = t, we[t] = r, t <<= 1, t & 256 && (t ^= 285);
...
(function(e) {
  const t = F, r = xe, n = ye, o = at, i = Cr, s = 7973, a = t.getBCHDigit(s);
  function l(h, f, p) {
    for (let g = 1; g <= 40; g++)
...
const Ce = F, Le = ye, pi = qn, wi = Yn, vi = Ao, bi = _o, gr = Oo, fr = xe, yi = Gn, ve = To, xi = Mo, $i = at, Ne = Ro;
function Ci(e, t) {
...
function _i(e, t) {
  const r = e.size, n = ve.getEncodedBits(t);
  let o, i, s;
  for (let a = 0; a < 18; a++)
...
function ki(e, t, r) {
  ...
  const o = Ce.getSymbolTotalCodewords(e), i = fr.getTotalCodewordsCount(e, t), s = (o - i) * 8;
...
function Ii(e, t, r) {
  const n = Ce.getSymbolTotalCodewords(t), o = fr.getTotalCodewordsCount(t, r), i = n - o, s = fr.getBlocksCount(t, r), a = n % s, l = s - a, c = Math.floor(n / s), d = Math.floor(i / s), b = d + 1, h = c - d, f = new yi(h);
  let p = 0;
...
function Ti(e, t, r, n) {
  ...
  if (Array.isArray(e))
    ...
    if (!c) {
      ...
      c = ve.getBestVersionForData(d, r);
    }
    o = Ne.fromString(e, c || 40);
  } else
    throw new Error("Invalid data");
  const i = ve.getBestVersionForData(o, r);
  if (!i)
...
`
  ...
  const s = ki(t, r, o), a = Ce.getSymbolSize(t), l = new wi(a);
  return Ci(l, t), Ei(l), Ai(l, t), Be(l, r, 0), t >= 7 && _i(l, t), Oi(l, s), isNaN(n) && (n = gr.getBestMask(
    l,
    Be.bind(null, l, r)
  )), gr.applyMask(n, l), Be(l, r, n), {
    modules: l,
    version: t,
...
Co.create = function(t, r) {
  ...
  let n = Le.M, o, i;
  return typeof r < "u" && (n = Le.from(r.errorCorrectionLevel, Le.M), o = ve.from(r.version), i = gr.from(r.maskPattern), r.toSJISFunc && Ce.setToSJISFunction(r.toSJISFunc)), Ti(t, o, n, i);
};
var No = {}, Er = {};
(function(e) {
  function t(r) {
...
function Mi(e, t, r) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    !l && !i && (i = !0), e[a] ? (s++, a > 0 && l > 0 && e[a - 1] || (n += i ? De("M", l + r, 0.5 + c + r) : De("m", o, 0), o = 0, i = !1), l + 1 < t && e[a + 1] || (n += De("h", s), s = 0)) : o++;
  }
  return n;
}
...
var Li = Object.defineProperty, Kr = Object.getOwnPropertySymbols, Ni = Object.prototype.hasOwnProperty, Bi = Object.prototype.propertyIsEnumerable, qr = (e, t, r) => t in e ? Li(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Ue = (e, t) => {
  for (var r in t || (t = {}))
...
var zi = Object.defineProperty, Fi = Object.getOwnPropertyDescriptor, je = (e, t, r, n) => {
...
Lt.styles = [O.globalCss, Hi], je([$({ type: Boolean })], Lt.prototype, "disabled", 2), je([$()], Lt.prototype, "variant", 2), Lt = je([k("wcm-button-big")], Lt);
...
We.styles = [O.globalCss, Zi], We = qi([k("wcm-info-footer")], We);
...
He.styles = [O.globalCss, Yi], He = Qi([k("wcm-modal-backcard")], He);
...
ze.styles = [O.globalCss, Xi], ze = rs([k("wcm-modal-content")], ze);
...
Fe.styles = [O.globalCss, os], Fe = ss([k("wcm-modal-footer")], Fe);
...
var hs = Object.defineProperty, us = Object.getOwnPropertyDescriptor, Ze = (e, t, r, n) => {
...
Bt.styles = [O.globalCss, ds], Ze([H()], Bt.prototype, "view", 2), Ze([H()], Bt.prototype, "prevView", 2), Bt = Ze([k("wcm-modal-router")], Bt);
...
const vs = { generate(e, t, r) {
  ...
  l.forEach(({ x: p, y: g }) => {
    ...
    for (let w = 0; w < l.length; w += 1) {
      const v = a * (J - w * 2);
      i.push(he`<rect fill="${w % 2 === 0 ? n : o}" height="${v}" rx="${v * y}" ry="${v * y}" width="${v}" x="${_ + a * w}" y="${u + a * w}">`);
    }
  });
  ...
  return h.forEach(([p, g]) => {
    ...
    const _ = g.filter((u) => g.every((y) => !Ve(u, y, a)));
    return [Number(p), _];
  }).forEach(([p, g]) => {
    g.forEach((_) => {
      i.push(he`<circle cx="${p}" cy="${_}" fill="${n}" r="${a / Gr}">`);
    });
  }), Object.entries(f).filter(([p, g]) => g.length > 1).map(([p, g]) => {
    const _ = g.filter((u) => g.some((y) => Ve(u, y, a)));
    return [Number(p), _];
  }).map(([p, g]) => {
    g.sort((u, y) => u < y ? -1 : 1);
    const _ = [];
    for (const u of g) {
      const y = _.find((w) => w.some((v) => Ve(u, v, a)));
      y ? y.push(u) : _.push([u]);
    }
    return [p, _.map((u) => [u[0], u[u.length - 1]])];
  }).forEach(([p, g]) => {
    g.forEach(([_, u]) => {
      i.push(he`<line x1="${p}" x2="${p}" y1="${_}" y2="${u}" stroke="${n}" stroke-width="${a / (Gr / 2)}" stroke-linecap="round">`);
    });
  }), i;
...
let X = class extends A {
  ...
  svgTemplate() {
    ...
    return he`<svg height="${e}" width="${e}">${vs.generate(this.uri, e, e / 4)}</svg>`;
  }
  render() {
...
Ke.styles = [O.globalCss, As], Ke = ks([k("wcm-spinner")], Ke);
...
var Ts = Object.defineProperty, Ps = Object.getOwnPropertyDescriptor, qe = (e, t, r, n) => {
...
Dt.styles = [O.globalCss, Is], qe([$()], Dt.prototype, "variant", 2), qe([$()], Dt.prototype, "color", 2), Dt = qe([k("wcm-text")], Dt);
...
Xr([H()], Ye.prototype, "preload", 2), Ye = Xr([k("wcm-explorer-context")], Ye);
...
Je.styles = [O.globalCss, zs], Je = Vs([k("wcm-android-wallet-selection")], Je);
...
Ge.styles = [O.globalCss, Js], Ge = Xs([k("wcm-desktop-wallet-selection")], Ge);
...
Qe.styles = [O.globalCss, ta], Qe = oa([k("wcm-legal-notice")], Qe);
...
Xe.styles = [O.globalCss, na], Xe = aa([k("wcm-mobile-wallet-selection")], Xe);
...
var ca = Object.defineProperty, da = Object.getOwnPropertyDescriptor, tr = (e, t, r, n) => {
...
Ut.styles = [O.globalCss, la], tr([H()], Ut.prototype, "open", 2), tr([H()], Ut.prototype, "active", 2), Ut = tr([k("wcm-modal")], Ut);
...
er.styles = [O.globalCss, ga], er = wa([k("wcm-view-all-wallets-button")], er);
...
rr.styles = [O.globalCss], rr = Ca([k("wcm-connect-wallet-view")], rr);
...
or.styles = [O.globalCss, Oa], or = Ta([k("wcm-install-wallet-view")], or);
...
nr.styles = [O.globalCss, Ra], nr = Ba([k("wcm-mobile-qr-connecting-view")], nr);
...
ir.styles = [O.globalCss], ir = ja([k("wcm-qrcode-view")], ir);
...
let ht = class extends A {
  ...
  isLastPage() {
    ...
    return n <= sr || r.length >= n;
  }
  async fetchWallets() {
    var e;
    const { wallets: t, search: r } = W.state, { listings: n, total: o, page: i } = this.search ? r : t;
    if (!this.endReached && (this.firstFetch || o > sr && n.length < o))
      try {
        this.loading = !0;
        const s = (e = K.state.chains) == null ? void 0 : e.join(","), { listings: a } = await W.getWallets({ page: this.firstFetch ? 1 : i + 1, entries: sr, search: this.search, version: 2, chains: s }), l = a.map((c) => x.getWalletIcon(c));
